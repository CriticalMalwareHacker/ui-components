...
const Menu = ({
    ...
    return (
        <div>
            <button
                className="w-full flex items-center justify-between text-gray-400 p-2 rounded-lg hover:bg-white/5 active:bg-white/10 duration-150"
...
const Sidebar = ({ collapsed, onToggle }: SidebarProps) => {
    ...
    const nestedNav: MenuItem[] = [
        { name: "Badge", href: "/Documentation/Components/badge/page" },
        { name: "Button", href: "/Documentation/Components/button" },
        { name: "Accordion", href: "/Documentation/Components/accordion/page" },
    ];
